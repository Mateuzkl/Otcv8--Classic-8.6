local window, appearanceGroup, colorModeGroup, colorBoxGroup, floor, movementCheck, showFloorCheck, showOutfitCheck, showMountCheck, showWingsCheck, showAuraCheck, showShaderCheck, showBarsCheck = nil
local colorBoxes = {}
...
function renamePreset()
	...
	function presetWidget.rename.save.onClick()
		saveRename(presetId)
	end
...
function rotate(value)
	...
	elseif Directions.West < direction then
